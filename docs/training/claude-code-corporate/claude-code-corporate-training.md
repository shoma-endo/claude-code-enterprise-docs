...
| 機能 | 説明 |
|---|---|
| オンボーディング | 役割・業務スタイルをヒアリングし、最適なフォルダ構成を自動生成 |
| タスク管理 | タスクの追加・確認・優先度づけ |
| メモ・受信箱 | その場でメモを inbox に記録し、後でまとめて整理 |
| アイデア記録 | ひらめきや企画案をカテゴリごとに蓄積 |
| 週次レビュー | 今週の完了・未完了・来週の重点を自動まとめ |
| ダッシュボード | 全カテゴリを俯瞰して優先事項を把握 |
...
| knowledge | 学んだことの蓄積 |
| reviews | 振り返り |
| content-plan | コンテンツ・発信計画 |
| journal | 日記・日誌 |
| reading-list | 読書・参考資料リスト |
| debugging | 不具合・技術メモ |

#### ロール別プリセット

オンボーディング時に役割を伝えると、職種に合ったカテゴリ構成を提案します。

| ロール | 主なカテゴリ例 |
|---|---|
| マネージャー | meetings、todos、projects、clients |
| 開発者 | todos、debugging、projects、research |
| クリエイター | ideas、content-plan、journal |
| フリーランス | clients、projects、finances、todos |
| 学生 | todos、research、knowledge、reading-list |
...
```text
メモ クライアントAの要望: 納期を2週間前倒ししたい。要件の再確認が必要。
```
