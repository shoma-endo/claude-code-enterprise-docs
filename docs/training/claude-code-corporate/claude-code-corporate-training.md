...
> [!NOTE]
> 2025年の調査では、日本企業の約4割が生成AIを業務に活用しており、主要課題として「セキュリティへの懸念」「AI人材の不足」「費用対効果の不透明さ」が挙げられています（[PwC Japan 生成AI実態調査 2025](https://www.pwc.com/jp/ja/knowledge/thoughtleadership/generative-ai-survey2025.html)）。
